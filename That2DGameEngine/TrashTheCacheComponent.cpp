...
that::TrashTheCacheComponent::TrashTheCacheComponent()
{
    //CalculateExercise1();
...
void that::TrashTheCacheComponent::OnGUI()
{
    RenderExercise1();
...
void that::TrashTheCacheComponent::RenderPlot(const std::vector<float>& samples, size_t verticalLineIndex)
{
...
void that::TrashTheCacheComponent::RenderDoublePlot()
{
...
void that::TrashTheCacheComponent::RenderExercise1()
{
...
void that::TrashTheCacheComponent::RenderExercise2()
{
    const ImGuiViewport* main_viewport = ImGui::GetMainViewport();
...
void that::TrashTheCacheComponent::CalculateExercise1()
{
...
void that::TrashTheCacheComponent::CalculateExercise2Normal()
{
...
void that::TrashTheCacheComponent::CalculateExercise2Alt()
{
